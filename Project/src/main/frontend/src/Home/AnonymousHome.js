    ...
    return <>
        ...
        <Row>
            ...
            <Col  xs={12} sm={12} md={12} lg={6} xl={6}>
                ...
                <p>
                    ...
                    Vous êtes l'heureux propriétaire d'une magnifique perceuse Bosch cadencée à 1000 rpm avec ses méches incassables
        ...
        <Row>
            <Col  xs={12} sm={12} md={12} lg={6} xl={6}>
                ...
                <br/>
                <p>Après un passage chez Ikea, vous avez dépensé vos dernières économies pour la table en verre Fäêkjö
                    mais vous vous rendez compte après coup que votre marteau n'est pas l'outil le plus adapté pour monter votre meuble.
