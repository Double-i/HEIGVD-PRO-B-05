...
class ConversationList extends React.Component {
    ...
    displayConversationContent(conv) {
        ...
        this.setState({
            currentConversation: <Conversation conversation={conv} participants={test}
        ...
        return (
            <div>
                <span style={this.openButtonStyle}>
                    <div className="speechBubble"><img
                        src="https://img.icons8.com/color/48/000000/speech-bubble-with-dots.png" onClick={() => {
                        this.toggle()
                    }}/></div>
                    {
                        this.state.opened ?
