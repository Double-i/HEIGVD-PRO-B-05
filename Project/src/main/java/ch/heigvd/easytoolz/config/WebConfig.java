...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("http://192.168.169.232:3000","http://127.0.0.1:3000","http://localhost:3000").allowedMethods("POST", "PATCH", "GET", "DELETE", "PUT").allowCredentials(true);
    }
